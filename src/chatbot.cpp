...
ChatBot::ChatBot()
{
  std::cout << "ChatBot no-arg Constructor" << std::endl;
...
: _image{source._image}, _chatLogic{source._chatLogic}, _rootNode{source._rootNode}, _currentNode{source._currentNode} {
